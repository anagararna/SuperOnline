    ...
    <div class="text-gray-900 pt-12 pr-0 pb-14 pl-0 bg-white">
        ...
        <div class="flex flex-col items-center sm:px-5 md:flex-row">
            ...
            <div class="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
                md:space-y-5">
                <div class="bg-fbd800 flex items-center leading-none rounded-full text-gray-50 pt-1.5 pr-3 pb-1.5 pl-2
                ...
                <p class="inline text-xs font-medium">Novedades</p>
                </div>
                <a class="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">Comprometidos. Con el cambio.</a>
                <div class="pt-2 pr-0 pb-0 pl-0">
                <p class="text-sm font-medium inline">autor:</p>
                <a class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">Ana Banana</a>
                <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· 10, Marzo 2023 ·</p>
        ...
        <div class="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
            ...
            <p class="bg-fbd800 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
                rounded-full uppercase inline-block">Patrocinios</p>
            ...
            <p class="bg-fbd800 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
                rounded-full uppercase inline-block">Mascotas</p>
            <a class="text-lg font-bold sm:text-xl md:text-2xl">Improving your day to the MAX</a>
            <p class="text-sm text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
            <div class="pt-2 pr-0 pb-0 pl-0">
            ...
            <p class="bg-fbd800 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
                rounded-full uppercase inline-block">Recetas</p>
            <a class="text-lg font-bold sm:text-xl md:text-2xl">Improving your day to the MAX</a>
            <p class="text-sm text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
            <div class="pt-2 pr-0 pb-0 pl-0">
