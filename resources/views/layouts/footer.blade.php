<!-- component -->
<footer class="relative py-5 flex flex-col items-center bg-f8e483 overflow-hidden md:py-20 lg:py-10 xl:py-5">
    <div class="relative z-[1] container m-auto px-4 md:px-8">
            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-700 sm:w-7/12 md:justify-start">
                    ...
                    <ul role="list" class="space-y-8">
                        <li>
                            <a href="#" class="flex items-center space-x-3 hover:text-00c6bb transition">
                ...
                <div class="w-10/12 m-auto  mt-20 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    <span class="block text-gray-500">superÁcido &copy; 2023</span>
                </div>
            </div>
        </div>
    </div>
